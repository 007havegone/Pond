    ...
    */
    ...
    if(argc > 3){
      ...
      for(int i = 3; i < argc; i++){
        if(strcmp(argv[i], "term") == 0){// 查找term的参数
      ...
      for(int i = 3; i < argc; i++){
        ...
        if(strcmp(argv[i], "-s") == 0){
          ...
          if(strcmp(argv[i], "astar") == 0){
            ...
            while(i+1 < argc && argv[i+1][0] != '-'){   // Check for replan arguments
              i++;
          ...
          if(strcmp(argv[i], "hop") == 0){
            ...
            int numSamples = 1;
            while(i+1 < argc && argv[i+1][0] != '-'){   // Check for [SC]HOP arguments
              i++;
            ...
            while(i+1 < argc && argv[i+1][0] != '-'){   // Check for PCHOP arguments
              i++;
        ...
        if(strcmp(argv[i], "-pst") == 0 || strcmp(argv[i], "-pspr") == 0){	// Alan- "pspr" is a temporary backwards compatability
